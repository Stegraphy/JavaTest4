...
curl -H "Content-Type:application/json" -X POST --data '{"first_name": "lei","last_name":"cong","email":"testgmail@qq.com","address":"47 MySakila Drive"}' http://$JAVA_IP:18080/customer

echo "================>update customer"
curl -H "Content-Type:application/json" -X PUT --data '{"first_name": "leiupdate","last_name":"cong","email":"testgmail@qq.com","address":"47 MySakila Drive"}' http://$JAVA_IP:18080/customer/600
